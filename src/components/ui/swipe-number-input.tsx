        ...
        <div className="relative">
          <input
            ...
            className={cn(
              ...
              swipeEnabled ? cn(
                "h-12 text-xl font-bold select-none text-center border-none outline-none shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 [&]:border-none [&]:outline-none [-webkit-tap-highlight-color:transparent]",
