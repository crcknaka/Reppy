...
const INERTIA_FRICTION_PER_MS = 0.997;
const INERTIA_RELEASE_IDLE_CUTOFF_MS = 200;
        ...
        <div className="relative">
          <input
            ...
            className={cn(
              ...
              swipeEnabled ? "h-12 text-xl font-bold select-none text-center border-none outline-none shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 caret-transparent [&]:border-none [&]:outline-none [-webkit-tap-highlight-color:transparent]" : "h-10 text-base md:text-sm rounded-xl border border-input bg-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:border-ring hover:border-muted-foreground/50",
              className,
            )}
            ...
            disabled={disabled}
            readOnly={readOnly}
            onFocus={(e) => { setIsFocused(true); e.target.select(); props.onFocus?.(e); }}
